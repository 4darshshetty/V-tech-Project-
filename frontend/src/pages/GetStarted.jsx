  ...
  return (
    <div className="relative min-h-screen">
      ...
      <div
        ...
        style={{
          backgroundImage: `linear-gradient(rgba(15,23,42,0.6), rgba(17,24,39,0.8)), url(${bg})`,
        }}
      />
      ...
      <div className="relative z-10 flex min-h-screen items-center justify-center px-4 py-24">
        <div className="max-w-4xl text-center text-white">
          <span className="inline-flex items-center rounded-full bg-white/10 px-4 py-1 text-xs uppercase tracking-[0.3em] text-sky-200">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-lg text-slate-100/80 md:text-xl">
            Discover precision-engineered electronics, tailored solutions, and a
            partner committed to elevating your digital future.
          </p>
          ...
          <div className="mt-10 flex flex-col items-center justify-center gap-6 md:flex-row">
            ...
            <a
              href="https://www.instagram.com/a_j_shetty_214?utm_source=qr&igsh=NnBoamt4djJzanpq"
